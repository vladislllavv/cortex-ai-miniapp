...
import { Home, Calendar, Zap, MoreHorizontal, Timer } from "lucide-react";
        ...
        <div style={{
          ...
          {isAi ? (
            <div style={{
              ...
              paddingBottom: NAV_HEIGHT + 4, maxWidth: 480, width: "100%",
            ...
            <div style={{
              ...
              WebkitOverflowScrolling: "touch" as any, paddingBottom: NAV_HEIGHT + 8,
            }}>
              <div style={{ padding: "12px 16px 20px", maxWidth: 480, margin: "0 auto", width: "100%", boxSizing: "border-box" }}>
                {(tab === "home" || tab === "plan") && <WorkspaceBar />}
                {tab === "home" && <HomePage onOpenPomodoro={() => setShowPomodoro(true)} />}
          ...
          <nav style={{
            ...
            borderTop: "1px solid rgba(255,255,255,0.07)", zIndex: 1000,
          }}>
            <div style={{
              ...
              {tabs.map(({ id, icon: Icon, label }) => {
                ...
                return (
                  <button key={id} onClick={() => setTab(id)} style={{
                    ...
                    padding: "6px 18px", position: "relative", fontFamily: "inherit",
                  }}>
                    {active && (
                      <div style={{
                        position: "absolute", top: 0, left: "50%",
                        transform: "translateX(-50%)", width: 24, height: 2,
                        borderRadius: 2, background: theme.primary,
                      }} />
                    )}
                    <div style={{
                    ...
                    <span style={{ fontSize: 10, fontWeight: active ? 700 : 400, color: active ? theme.primary : "rgba(255,255,255,0.3)" }}>
                      {label}
                    </span>
                  </button>
                );
